...
`/api/auth/**` има броење по клиент: најава 10 во 5 минути, регистрација и
заборавена лозинка 5 на час. Над тоа одговорот е 429. Броењето е во меморија —
со повеќе инстанци ова оди во Redis. `X-Forwarded-For` се верува само кога
`TRUST_FORWARDED_FOR=true`, инаку секој би можел да прати измислена адреса.
